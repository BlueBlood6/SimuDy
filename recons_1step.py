'''Implementation of Buzaglo et al.’s method

Reference:
[1] Gon Buzaglo, Niv Haim, Gilad Yehudai, Gal Vardi, Yakir Oz, Yaniv Nikankin, and Michal Irani. 
...
def set_logger(log_name, log_dir, args):
    ...
    file_handler = logging.FileHandler(
        os.path.join(
            log_dir,
            f"{args.model_name}_{args.dataset}_num_img{args.num_imgs_per_class*num_classes}_bsz{args.bs}_tlr{args.tlr}_1step.log",
        )
    )
